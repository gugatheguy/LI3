...
public class GestVendas2 implements IGereVendasModel,Serializable{
    ...
    public GestVendas2(){
        this.prods = new Produtos2();
        this.fils = new Filiais2();
        this.clients = new Clientes2();
        this.ft = new FactTotal2();
        this.d = new Dados();
    }
    ...
    public void gravaEstado() throws IOException {
        gravaEstado("dados/GestVendas2.dat");
    }
    ...
    private void cloneToSelf(GestVendas2 g){
        this.ft = g.ft;
